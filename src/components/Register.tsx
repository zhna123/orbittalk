  ...
  return (
    <div className='max-w-screen-sm sm:max-w-xs self-center w-full'>
      ...
      <form onSubmit={ handleSubmit(onSubmit) } className='py-8 flex flex-col gap-2' noValidate>
        ...
        {
          !formSubmitted ? 
          <input type="submit" value="Sign Up" aria-label="submit" className='form-input mt-8 border-none rounded-md text-red-100 bg-red-500 cursor-pointer active:bg-red-600'/>
          :
